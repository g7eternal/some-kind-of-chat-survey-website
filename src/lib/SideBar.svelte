...
<div class="sidebar" class:collapsed={!presence}>
  <button
    class="btn-slider bg-body-secondary text-warning"
  ...
  <ul class="nav flex-column bg-body-secondary border-end">
        ...
        <li class="nav-item">
          <div class="form-check my-1">
            <input
              ...
              type="checkbox"
              value=""
              id="pollOptions_hideAvatars"
              bind:checked={$settings.hideAvatars}
            />
    ...
    {#if currentBlock === "default"}
      <li class="nav-item">
        <RestartBlock {poll} mini={!presence} />
      </li>
      <li class="nav-item">
    ...
    <li class="nav-item">
      ...
      <div class="btn-group-vertical w-100">
        ...
        <label
          ...
          for="pollMode_default"
          use:tippy={{
            placement: "left",
            content: "Switch to <b>default poll</b>",
            allowHTML: true,
          }}
        >
          <span class="material-icons">&#xe172;</span>
        ...
        <label
          ...
          use:tippy={{
            placement: "left",
            content: "Switch to <b>Yes/No poll</b>",
            allowHTML: true,
          }}
        >
          <span class="material-icons">&#xef50;</span>
        ...
        <label
          ...
          use:tippy={{
            placement: "left",
            content: "Switch to <b>raffle mode</b>",
            allowHTML: true,
          }}
        >
          <span class="material-icons">&#xea74;</span>
...
<style>
  ...
  .btn-slider span {
    ...
    filter: none;
    transition: text-shadow 0.2s ease, filter 0.2s ease, transform 0.3s ease-out;
  }
