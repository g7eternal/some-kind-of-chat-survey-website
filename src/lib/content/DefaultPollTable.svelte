<script>
  ...
  const iconAsc  = "<span class='ml-auto mr-1 material-icons fs-5' style='opacity:0.8'>&#xe316;</span>";
  const iconDesc = "<span class='ml-auto mr-1 material-icons fs-5' style='opacity:0.8'>&#xe313;</span>";
...
<div class="table-outer">
  ...
  <SvelteTable {columns} rows={data} sortBy="id" rowKey="id"
    ...
    showExpandIcon={true} expandSingle={true}
    {iconAsc} {iconDesc} {iconExpand} iconExpanded={iconExpand}
